...
(function() {
  ...
  gen_posh = function(cert) {
    return async.parallel([
      ...
      var cn, commonName, fing, modulus, posh, _ref, _ref1, _ref2;
      if (er) {
        complain(er);
      }
      (_ref = results[0], modulus = _ref.modulus), (_ref1 = results[1], fing = _ref1.fingerprint), (_ref2 = results[2], commonName = _ref2.commonName, cn = _ref2.cn);
