...
(function() {
            ...
            case 2:
              if ((m = ss.match(/^(\d+)\s+([^\n]+)$/m))) {
                if (m[1] === '220') {
                  ...
                  _this.wait.reject("start-tls FAILURE: " + m[1]);
                  return _this.wait = null;
                }
              }
          }
  ...
  this.POSHpop = (function(superClass) {
    extend(POSHpop, superClass);

    function POSHpop(domain, options) {
      var got_data, opts, ref, ref1, ref2, ref3, ref4, srv, ss, state;
      if (options == null) {
        options = {};
      }
      ...
      if (opts.start_tls) {
        srv = '_pop3';
        opts.fallback_port = (ref3 = options.fallback_port) != null ? ref3 : 110;
      } else {
        srv = '_pop3s';
        opts.fallback_port = (ref4 = options.fallback_port) != null ? ref4 : 995;
      }
      POSHpop.__super__.constructor.call(this, domain, srv + "._tcp", opts);
      state = 0;
      ss = '';
      got_data = (function(_this) {
        return function(data) {
